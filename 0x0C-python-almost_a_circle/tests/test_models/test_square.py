...
class TestSquare(unittest.TestCase):
    """square.Square class test """
    @classmethod
    def setUpClass(cls):
        """set up the tests"""
        base.Base._Base__nb_objects = 0
        cls.s1 = square.Square(1)
        cls.s2 = square.Square(2, 3)
        cls.s3 = square.Square(4, 5, 6)
        cls.s4 = square.Square(7, 8, 9, 10)
    ...
    def test_size_typeerror(self):
        ...
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            sq = square.Square("osoti")
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            sq = square.Square(True)

    def test_x_typeerror(self):
        """Test that non-integers for x raise typeerror"""
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            sq = square.Square(1, "osoti")
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            sq = square.Square(1, True)

    def test_y_typeerror(self):
        """Test that non-integers for y raise typeerror"""
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            sq = square.Square(1, 1, "kulundeng")
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            sq = square.Square(1, 1, True)
    ...
    def test_str(self):
        ...
        self.assertEqual(str(self.s1), "[square.Square] (1) 0/0 - 1")
        self.assertEqual(str(self.s2), "[square.Square] (2) 3/0 - 2")
        self.assertEqual(str(self.s3), "[square.Square] (3) 5/6 - 4")
        self.assertEqual(str(self.s4), "[square.Square] (10) 8/9 - 7")
    ...
    def test_update_args(self):
        ...
        sq = square.Square(1, 0, 0, 1)
        self.assertEqual(str(sq), "[square.Square] (1) 0/0 - 1")
        sq.update(89)
        self.assertEqual(str(sq), "[square.Square] (89) 0/0 - 1")
        sq.update(89, 2)
        self.assertEqual(str(sq), "[square.Square] (89) 0/0 - 2")
        sq.update(89, 2, 3)
        self.assertEqual(str(sq), "[square.Square] (89) 3/0 - 2")
        sq.update(89, 2, 3, 4)
        self.assertEqual(str(sq), "[square.Square] (89) 3/4 - 2")
    ...
    def test_update_too_many_args(self):
        ...
        sq = square.Square(1, 0, 0, 1)
        sq.update(1, 1, 1, 1, 2)
        self.assertEqual(str(sq), "[square.Square] (1) 1/1 - 1")
    ...
    def test_update_kwargs(self):
        ...
        self.assertEqual(str(sq), "[square.Square] (1) 0/0 - 1")
        sq.update(size=10)
        self.assertEqual(str(sq), "[square.Square] (1) 0/0 - 10")
        sq.update(size=11, x=2)
        self.assertEqual(str(sq), "[square.Square] (1) 2/0 - 11")
        sq.update(y=3, size=4, x=5, id=89)
        self.assertEqual(str(sq), "[square.Square] (89) 5/3 - 4")

    def test_update_kwargs_setter(self):
        """tests that the update method uses setter with **kwargs"""
        sq = square.Square(1, 1, 1, 1)
        with self.assertRaises(TypeError):
    ...
    def test_mix_args_kwargs(self):
        ...
        self.assertEqual(str(sq), "[square.Square] (2) 2/2 - 2")
    ...
    def test_save_to_file(self):
        ...
        s1 = square.Square(1, 1, 1, 1)
        s2 = square.Square(2, 2, 2, 2)
        l = [s1, s2]
        square.Square.save_to_file(l)
        with open("square.Square.json", "r") as f:
    ...
    def test_stf_None(self):
        ...
        square.Square.save_to_file(None)
        with open("square.Square.json", "r") as f:
            self.assertEqual("[]", f.read())
    ...
    def test_create(self):
        ...
        s1c = square.Square.create(**s1)
        s2c = square.Square.create(**s2)
        self.assertEqual("[square.Square] (2) 4/0 - 3", str(s1c))
        self.assertEqual("[square.Square] (9) 7/8 - 6", str(s2c))
    ...
    def test_load_from_file_empty_file(self):
        ...
        try:
            ...
            pass
        open("square.Square.json", 'a').close()
        self.assertEqual(square.Square.load_from_file(), [])

    def test_load_from_file(self):
        """test normal use of load_from_file"""
        s1 = square.Square(2, 3, 4, 5)
        s2 = square.Square(7, 8, 9, 10)
        li = [s1, s2]
        square.Square.save_to_file(li)
        lo = square.Square.load_from_file()
        self.assertTrue(type(lo) is list)
        self.assertEqual(len(lo), 2)
        s1c = lo[0]
        s2c = lo[1]
        self.assertTrue(type(s1c) is square.Square)
        self.assertTrue(type(s2c) is square.Square)
